...
function ProductDetailPage() {
    ...
    return (
        <>
            ...
            {product !== [] ? <><div className="product-details-area pt-120 pb-115">
                    ...
                    <div className="row">
                            ...
                            <div className="product-details-tab">
                                <div className="pro-dec-big-img-slider">
                                    <div className="easyzoom-style">
                                        ...
                                        <a className="easyzoom-pop-up img-popup" href="../assets/images/product-details/b-large-1.jpg"><i className="icon-size-fullscreen" /></a>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-6 col-md-6">
                            ...
                            <div className="pro-details-price">
                                <span className="new-price">{VNDCurrency(product[0].price)}</span>
                                <span className="old-price">{VNDCurrency(product[0].price*110/100)}</span>
                            </div>
