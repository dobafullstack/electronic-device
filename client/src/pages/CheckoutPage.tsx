                                    ...
                                    <div className="your-order-wrap gray-bg-4">
                                        ...
                                        <div className="payment-method">
                                            <div className="pay-top sin-payment">
                                                <input id="payment_method_1" className="input-radio" type="radio" defaultValue="cheque" defaultChecked={true} name="payment_method" />
                                            ...
                                            <div className="pay-top sin-payment sin-payment-3">
                                                ...
                                                <label htmlFor="payment-method-4">PayPal <img alt="" src="assets/images/icon-img/payment.png" /><a href="#">What is PayPal?</a></label>
                                                <div className="payment-box payment_method_bacs">
                                                    <p>Make your payment directly into our bank account. Please use your Order ID as the payment reference.</p>
                                                </div>
                                            </div>
