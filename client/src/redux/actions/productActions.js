...
export const getSaleItemsByCategoryIdAction =
    (categoryId) => async (dispatch) => {
        try {
            const { code, result, error } =
                await productApi.getSaleItemsByCategoryId(categoryId);
...
export const getProductByIdAction = (productId) => async (dispatch) => {
    try {
        const { code, result, error } = await productApi.getProductById(
            productId
        );
...
export const getProductsByCategoryIdAction = (categoryId) => async (dispatch) => {
    try {
        const { code, result, error } = await productApi.getProductsByCategoryId(categoryId);
...
export const getProductsByCategoryDetailIdAction = (categoryDetailId) => async (dispatch) => {
    try {
        const { code, result, error } =
