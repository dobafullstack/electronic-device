...
module.exports = {
  ...
  'pages.store': 'Tienda',
  'pages.store.categories': 'Categorías',
  'pages.store.products': 'Productos',
  'pages.store.attributes': 'Atributos',
  'pages.store.orders': 'Pedidos',
  'pages.store.bills': 'Facturas',
  'pages.auth': 'Autenticación',
  'pages.auth.users': 'Usuaria',
  'pages.auth.roles': 'Papel',
