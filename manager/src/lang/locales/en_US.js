...
module.exports = {
  ...
  'menu.orders': 'Prders',
  'menu.bills': 'Bills',
  'menu.list-attributes': 'List Attributes',
  'menu.list-product': 'List Products',
  ...
  'pages.store': 'Store',
  'pages.store.categories': 'Categories',
  'pages.store.products': 'Products',
  'pages.store.attributes': 'Attributes',
  'pages.store.orders': 'Orders',
  'pages.store.bills': 'Bills',
  'pages.auth': 'Authentication',
  'pages.auth.users': 'Users',
  'pages.auth.roles': 'Roles',
